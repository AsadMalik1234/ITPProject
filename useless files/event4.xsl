		...
		<html>
			...
			<div id="content">
				...
				<div class="alt3 padding" id="game">
					<embed src="images/RebelEscape.swf" width="100%" height="600" />
				</div>
				<div class="alt4 padding" id="info">
				<h1> infromation of gif</h1>
				<p>Name <xsl:apply-templates select="/catalog/event[4]/name"/></p>
				<p>Info <xsl:apply-templates select="/catalog/event[4]/information"/></p>
				</div>
				<!--
