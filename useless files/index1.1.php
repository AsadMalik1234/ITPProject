...
<html>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navHeaderCollapse">
				<h4 class="nav navbar-nav navbar-right">
					...
					<li><a href="#Irish history">Irish History</a></li>
				</h4>
			</div>
		</div>
	</div>
	...
	<div class="alt3 padding" id="games">

	<p> games in this section</p>
	this is the area of game
	</div>
	
	
	<div class="alt4 padding" id="gif information">

	<p> infromation of gif</p>
	
	</div>
	
	<div class="alt5 padding" id="api">
...
<a href="https://itpproject-asadmalik111.c9users.io/PROJECT%201/index1.2.php"><img src="next.jpeg" alt="next page" style="width:50px;height:50px;border:0"> </a>

<a href="https://itpproject-asadmalik111.c9users.io/PROJECT%201/index1.php"><img src="back.jpeg" alt="next page" style="width:50px;height:50px;border:0"> </a>
<!--	
	<div class="jumbotron">
		<div class="container">
			<h1>Hello World!</h1>
